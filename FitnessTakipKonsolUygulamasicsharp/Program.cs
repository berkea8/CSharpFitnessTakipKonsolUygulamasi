            ...
            cinsiyet:
                ...
                if (cinsiyet == 1) //kadin
                {
                    ...
                    switch (aktivite)
                    {
                        ...
                        default:
                            Console.Clear();
                            Console.WriteLine("Gecersiz Seçim. Lutfen Tekrar Deneyin.");
                            break;
                    }
                }
            ...
            public static void AntremanGoruntule() // Antreman seceneklerini iceren metoddur.
            {
                while (true)
                {
                    ...
                    switch (antremanSecim)
                    {
                        ...
                        haftaE:
                            Console.WriteLine("Lutfen haftayi girin (1-4): ");
                            int degisken = intkontrol();
                            if (degisken > 4 || degisken <= 0)
                            {
                                Console.Clear();
                                Goruntuleme.AylikTakvimGoruntule();
                                Console.WriteLine("Lutfen dogru aralıkta deger giriniz");
                                goto haftaE;
                            }
                            else hafta = degisken;
                            ...
                            gunE:
                            Console.WriteLine("Lutfen gunu girin (1-7): ");
                            int gun = (intkontrol());
                            if (gun > 7 || gun <= 0)
                            {
                                Console.Clear();
                                Goruntuleme.AylikTakvimGoruntule();
                                Console.WriteLine("Lutfen dogru aralikta deger giriniz");
                                goto gunE;
                            }

                            Console.WriteLine("Lutfen antrenman bilgisini girin: ");
                        ...
                        haftaT:
                            ...
                            if (!string.IsNullOrEmpty(tamamlananAntrenman))
                            {
                                ...
                                Console.Clear();
                                Goruntuleme.AylikTakvimGoruntule();
                                Console.WriteLine("Antrenman Tamamlandi ve Kaldirildi.");
                            }
                            else
                            {
                                Console.WriteLine("Bu hucrede antrenman bulunmamaktadir.");
                            }
                            break;
                        ...
                        haftaS:
                            ...
                            emin:
                                gunSil = degisken4;
                                Console.WriteLine("Silmek istediginize emin misiniz?(1-Evet,2-Hayir)");
                                int emin = intkontrol();
                                if (emin == 1)
                                {
                        ...
                        case "5":
                            Console.WriteLine("Ana Menuye Don seçeneği secildi.");
                            Console.Clear();
                            return;
